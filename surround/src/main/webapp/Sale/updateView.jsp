...
<script src="<c:url value="/src/jquery111.js" />" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min.js"></script>
	...
	<script src="<c:url value="/Sale/src/jquery/bootstrap.min.js" />"></script>
	<link href="<c:url value="/Sale/boot/bootstrap.min.css" />" rel="stylesheet">
	<style>
...
<form enctype="multipart/form-data" method="POST" action="<c:url value="/updatedel" />">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="sale_topic" value="${update.sale_topic}"">
      ...
      <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="sale_name" value="${update.sale_name}">
	   <font size="-1" color="#FF0000">${errors.sale_name}</font>
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="sale_locate" value="${update.sale_locate}">
 ...
 <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="datetimepicker1" placeholder="" name="sale_time" value="${update.sale_time}">
      ...
      <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="sale_memo" value="${update.sale_memo}">
      ...
      <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="product_name" value="${element.product_name}">
      ...
      <br/>
       ...
       <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="product_price" value="${element.product_price}">
       ...
       <div class="form-group form-group-sm">
	    ...
	    <div class="col-sm-10">
	      <input class="form-control" type="text" id="formGroupInputSmall" placeholder="" name="product_memo" value="${element.product_memo}">
