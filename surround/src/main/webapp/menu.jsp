        ...
        function clickicon1() {
        	...
        	<!--第三組標籤設定 -->
        	 ...
        	 var marker3 = new google.maps.Marker({
        		 position: {lat:${sessionScope.selectsale[7].sale_lng},lng:${sessionScope.selectsale[7].sale_lat}},
        		 map: map,
        		 icon:"<c:url value="/img/mapicon/hotfoodcheckpoint.png"/>",
        		 title: 'Eating!'
        	   });
            ...
            for(var a=0;a<1;a++){
            	var lat = "${element.selectsale["+a+"].sale_lat}";
            	
            	var lng = "${element.selectsale["+a+"].sale_lng}";
