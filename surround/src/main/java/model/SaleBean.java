...
//新增或修改			
		model.MemberBean memberBean = new model.MemberBean(); // 部門POJO
			...
			saleBean.setSale_lng(null);
			saleBean.setSale_lat(null);
			session.saveOrUpdate(saleBean);
//刪除
//		SaleBean saledelete = session.get(SaleBean.class,9);
//		session.delete(saledelete);
	...
	@ManyToOne(fetch=FetchType.EAGER) //(雙向多對一/一對多)的多對一    //【原預設為 @ManyToOne(fetch=FetchType.LAZY)】--> 【是指原為lazy="true"之意】
...
//	}	
//
//>>>>>>> branch 'master' of https://github.com/EEIT90TEAM3/surroundU.git
